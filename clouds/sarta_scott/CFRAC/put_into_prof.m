...
%%%%%
%%%%% use cFrac for cfrac for cfrac1,cfrac2,cfrac12 instead of 1
...
cfrac = cFrac(1);   %cfrac = profX.cfrac(ii);
...
if length(cTYPE) == 1
  ...
  prof.cfrac(jj)   = cFrac(1);
  if cTYPE(kk) == 'I'
    prof.ctype(jj)  = 201;
    prof.cpsize(jj) = 30;   %% typical ice particles
    icefound        = +1;
  elseif cTYPE(kk) == 'W'
    prof.ctype(jj)  = 101;
    prof.cpsize(jj) = 15;  %% typical water particles
    waterfound      = +1;
    end
...
if length(cTYPE) == 2
  ...
  prof.udef(15,jj) = cFrac(2); %%cfrac2
  if cTYPE(kk) == 'I'
    prof.udef(17,jj) = 201;
    prof.udef(12,jj) = 30;   %% typical ice particles
    icefound         = +1;
  elseif cTYPE(kk) == 'W'
    prof.udef(17,jj) = 101;
    prof.udef(12,jj) = 15;  %% typical water particles
    waterfound       = +1;
    end
