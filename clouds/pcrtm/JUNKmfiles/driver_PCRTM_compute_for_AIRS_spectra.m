...
% clustcmd -L driver_PCRTM_compute_for_AIRS_spectra.m YYYYMMDDHH0:YYYYMMDDHHF
% eg 2012050100
% clustcmd -L driver_PCRTM_compute_for_AIRS_spectra.m YYYMMDDHH0:YYYYMMDDHHF

% otherwise when happy
% clustcmd -q medium -n 12 -p 1 driver_PCRTM_compute_for_AIRS_spectra.m 2012050100:2012053123
%
% or
% clustcmd -q long_contrib -n 12 -p 1 driver_PCRTM_compute_for_AIRS_spectra.m 2012050100:2012053123
...
ncol0 = 50;
thefilenameOUT = [thedateDIR '/cld_era_41ch.airs_ctr.' dotstr '.pcrtm.ncol' num2str(ncol0) '.rtp'];
...
elseif eeOUT > 0
  ...
  %%p0 = simple_subset(1000,p0);       %% for debug <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
