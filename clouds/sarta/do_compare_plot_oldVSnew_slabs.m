function [] = do_compare_plot_oldVSnew_slabs(prof,pINPUT,iCompareSlabs)

if iCompareSlabs > 0 & isfield('cfrac',prof) & isfield('cprtop',prof) ...
                     & isfield('cpsize',prof) & isfield('cngwat',prof) ...
                     & isfield('cfrac',pINPUT) & isfield('cprtop',pINPUT) ...
                     & isfield('cpsize',pINPUT) & isfield('cngwat',pINPUT) ...
