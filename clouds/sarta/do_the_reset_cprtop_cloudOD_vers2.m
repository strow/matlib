...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% now do fixes if cumsumOD == -9999
if cumsumOD == -9999
  for ii = 1 : 3
    oo = find(p1.ctype == 201 & p1.cfrac > 0 & p1.cngwat > 0 & p1.cprtop > 400 & p1.ctype2 ~= 201);
    if length(oo) > 0
      fprintf(1,' A1 do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to above 400 mb \n',length(oo));
      p1.cprtop(oo) = 380;
      p1.cprbot(oo) = 430;
    end
    oo = find(p1.ctype == 201 & p1.cfrac > 0 & p1.cngwat > 0 & p1.cprtop > 400 & p1.ctype2 == 201);
    if length(oo) > 0
      fprintf(1,' B1 do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to above 400 mb \n',length(oo));
      p1.cprtop(oo) = 380;
      p1.cprbot(oo) = 430;
    end
    
    oo = find(p1.ctype2 == 201 & p1.cfrac2 > 0 & p1.cngwat2 > 0 & p1.cprtop2 > 400 & p1.ctype ~= 201);
    if length(oo) > 0
      fprintf(1,' A2 do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to above 400 mb \n',length(oo));
      p1.cprtop2(oo) = 380;
      p1.cprbot2(oo) = 430;
      %fprintf(1,' do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to waterclouds \n',length(oo));
      %p1.ctype2(oo) = 101;
      %p1.cpsize2(oo) = 20;
    end
    ...
    oo = find(p1.ctype2 == 201 & p1.cfrac2 > 0 & p1.cngwat2 > 0 & p1.cprtop2 > 400 & p1.ctype == 201);
    if length(oo) > 0
      fprintf(1,' B2 do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to above 400 mb \n',length(oo));
      p1.cprtop2(oo) = 380;
      p1.cprbot2(oo) = 430;
      %fprintf(1,' do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to waterclouds \n',length(oo));
      %p1.ctype2(oo) = 101;
...
if cumsumOD == -9999
  for ii = 1 : 3
    oo = find(p1.ctype == 101 & p1.cfrac > 0 & p1.cngwat > 0 & p1.cprtop < 400 & p1.ctype2 ~= 101);
    if length(oo) > 0
      fprintf(1,' A1 do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to above 400 mb \n',length(oo));
      p1.cprtop(oo) = 480;
      p1.cprbot(oo) = 530;
    ...
    oo = find(p1.ctype2 == 101 & p1.cfrac2 > 0 & p1.cngwat2 > 0 & p1.cprtop2 < 400 & p1.ctype ~= 101);
    if length(oo) > 0
      fprintf(1,' A2 do_the_reset_cprtop_cloudOD_vers2.m called by do_the_reset_cprtop_cloudOD.m called by reset_cprtop_cloudOD.m called by main_code_to_make_slabs.m, resetting %5i icecloud tops to above 400 mb \n',length(oo));
      p1.cprtop2(oo) = 480;
      p1.cprbot2(oo) = 530;
