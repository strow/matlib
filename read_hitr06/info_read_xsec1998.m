function [data,info] = info_read_xsec1998(fname);

% function [data,info] = info_read_xsec1998(fname);
%
% Read HITRAN 1998 IR cross-section data
%
% Input:
...
% Update: 14 July 2010, S.Hannon - 1998 variant created
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%
   if (lheader == 1)
      ...
      % read header
      info.chemical_symbol = tline(1:10);
      info.fmin(ncount) = str2num( tline(11:20) );
      info.fmax(ncount) = str2num( tline(21:30) );
      info.npts(ncount) = str2num( tline(31:40) );
      info.temperature(ncount) = str2num( tline(41:50) );
      info.pressure(ncount) = str2num( tline(51:60) );
      info.max_xsec(ncount) = str2num( tline(61:70) );
%      info.FTS_resolution(ncount) = str2num( tline(71:75) );
      info.common_name = tline(77:86);
%      % Note: tline(91-94) not used
%      info.broadening_gas = tline(95:97);
      info.reference_num = str2num( tline(71:76) );
      %
      lheader = 0;
      mcount = 0;
      %
