function [year, month, day, dhour] = tai2utc2000(tai);
...
%
% Input:
%    tai : (1 x n) seconds since 00:00 1 Jan 2000
%
% Output:
...
% Update: 17 April 2007, S.Hannon - 2000 variant created
% Update: 07 July 2009, S.Hannon - fix rare bad day of month (eg 297129600
%    returned 0z 32 May 2009 instead of 0z 01 June 2009)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
