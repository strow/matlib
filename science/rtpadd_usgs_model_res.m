function [h ha p pa] = rtpadd_usgs_10dem(h,ha,p,pa,root,model)
...
% Breno Imbiriba - 2013.03.14
  ...
  [salti landfrac] = usgs_model_res(p.rlat, p.rlon, model, wgf);
  ...
  pa = set_attr(pa, 'landfrac',['USGS Land Fraction at ' model ' Res']);
  pa = set_attr(pa, 'salti',['USGS surface altitude at ' model ' Res']);
